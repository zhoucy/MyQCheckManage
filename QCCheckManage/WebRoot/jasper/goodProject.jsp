 ...
 Connection conn =null;
     ...
     {    Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
  	  conn = DriverManager.getConnection(
            "jdbc:sqlserver://192.168.8.197;DatabaseName=KEDB", "sa", "1A2s3d4f5g");
		 ...
		 */
		 String project = request.getParameter("prodectType");//产品类型
        ...
        File reportFile = new File(application.getRealPath("jasper/goodProject.jasper"));
        ...
        if("pdf".equals(type)){  
		   ...
		   exporter.setParameter(JRHtmlExporterParameter.IMAGES_URI, "/jasper?image=img_0_0_2");
