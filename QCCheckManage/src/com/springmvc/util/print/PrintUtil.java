...
public class PrintUtil implements Printable{
	...
	private List<PrintEntity> pss=new ArrayList<PrintEntity>();
	...
	public PrintResult print(String content,String printName){		
		...
		final PrintResult result=new PrintResult();
		final List<PrintJobEvent> pjeList=new ArrayList<PrintJobEvent>();
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
		if(pageIndex==0){
			...
			if(ps!=null){
				g2d.drawImage(img,ps.getX(4),-2,25,25,null);                         //右起第1格
				...
				g2d.drawString(ps.getCount().toString(), ps.getX(0)-26, 20);
			}
